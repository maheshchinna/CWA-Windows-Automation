...
public class ScreenRecorderUtil extends ScreenRecorder {
    ...
    public static File recorderFolder ;
    public static void createRecordingFolder() {
        SimpleDateFormat dateFormat = new SimpleDateFormat("dd-MM-YYYY HH.mm");
        recorderFolder = new File("recordings/recorded_on_" + dateFormat.format(new Date()));
    ...
    public static void startRecord(String methodName){
        try {
            ...
            screenRecorder = new ScreenRecorderUtil(gc, captureSize,
                    ...
                    null, recorderFolder, methodName);
